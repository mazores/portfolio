          ...
          descriptions: [
            {
              descriptionId: 1,
              paragraph:
                "The Regional HIV/AIDS Connection or RHAC is an organization dedicated to positively impacting the lives of individual living with, at-risk for, or affected by HIV/AIDS and Hepatitis C."
            },
            {
              descriptionId: 2,
              paragraph:
                "Our group was tasked to create an all-around marketing campaign targeted towards teens ages 14-18 about HIV/AIDS."
            },
            {
              descriptionId: 3,
              paragraph:
                "As the Project Manager of the campaign, I lead the team through the research, development, and production of the campaign. I contributed to the different aspects of the campaign - research, branding, graphic design, motion design, and web development - all while making sure that the project was right on track towards our goals."
            },
            {
              descriptionId: 4,
              paragraph:
                "Other than being a Project Manager, I was in charge of the web design and UI/UX. My other contributions to the project was doing the audience research, coming up with the campaign name, contributing code to the developer, animating the logo, and developing the template for the campaign’s videos."
            },
            {
              descriptionId: 5,
              paragraph:
                "We kickstarted the campaign by researching who our campaign is targeted towards and made sure that they were the driving force behind our decisions and choices. We made sure that the campaign was very research-based."
            }
          ],
          images: [
            {
              imageId: 1,
              visual: "meethiv01.png"
            },
            {
              imageId: 2,
              visual: "meethiv02.png"
            },
            {
              imageId: 3,
              visual: "meethiv03.gif"
            },
            {
              imageId: 4,
              visual: "meethiv04.png"
            },
            {
              imageId: 5,
              visual: "meethiv05.png"
            },
            {
              imageId: 6,
              visual: "meethiv06.png"
            },
            {
              imageId: 7,
              visual: "meethiv07.png"
            },
            {
              imageId: 8,
              visual: "meethiv08.png"
            },
            {
              imageId: 9,
              visual: "meethiv09.png"
            },
            {
              imageId: 10,
              visual: "meethiv10.png"
            },
            {
              imageId: 11,
              visual: "meethiv11.png"
            },
            {
              imageId: 12,
              visual: "meethiv12.png"
            },
            {
              imageId: 13,
              visual: "meethiv13.png"
            },
            {
              imageId: 14,
              visual: "meethiv14.png"
            },
            {
              imageId: 15,
              visual: "meethiv15.png"
            },
            {
              imageId: 16,
              visual: "meethiv16.png"
            },
            {
              imageId: 17,
              visual: "meethiv17.png"
            },
            {
              imageId: 18,
              visual: "meethiv18.png"
            },
            {
              imageId: 19,
              visual: "meethiv19.png"
            }
          ]
        },
